...
exports.createThread = async (req, res) => {
  try {
    ...
    const thread = new Thread({
      ...
      created_on: now,
      bumped_on: now,
      reported: false,  // Asegurar que exista explícitamente
      replies: []       // Asegurar que el array exista
    });
...
exports.createReply = async (req, res) => {
  try {
    ...
    // Usar el método push de Mongoose directamente para que genere el _id automáticamente
    thread.replies.push({
      text,
      delete_password,
      created_on: now,
